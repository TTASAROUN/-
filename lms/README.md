...
- `/` 홈페이지 · `/admin` 업무 콘솔 (초기 계정 admin / 1234) · `/student` 훈련생 포털 (이름+생년월일+연락처 뒤 4자리) · `/survey.html?id=설문ID` 설문 응답
- 기관명은 따사로운 평생교육원. 기관 구분(예: 통합서비스 추가)은 기타관리 > 기관 설정에서 넣으면 상단 탭이 생김
